...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CDrwuKeZ.mjs");
...
var manifest = {
	"ccfa28a77e3f768db9d597ba66f4bd52e9be29ad2616e9932791de0123ab63ee": {
		functionName: "saveWorkspace_createServerFn_handler",
		importer: () => import("./persist-D8yMeAnG.mjs")
	},
	"e3bfff75aac896f885bc78eea0ac93b6c865572ec4971c425046daccfbb3f7fc": {
		functionName: "loadWorkspace_createServerFn_handler",
		importer: () => import("./persist-D8yMeAnG.mjs")
	},
	"f8ce3e2eca644d9b7e118cfa05000e186f75b9447d1c02f8fcf5ff9613de683a": {
		functionName: "completeAiCell_createServerFn_handler",
		importer: () => import("./ai-Dk0MDi0A.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D5th-1W0.mjs").then((n) => n.t),
